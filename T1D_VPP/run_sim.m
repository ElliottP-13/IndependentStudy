...
%% loading the VPP
    ...
    load('Single Hormone Population/Test Population/SingleHormone_VPP.mat');
    addpath('Single Hormone Population/Create Population');
    addpath('Single Hormone Population/Test Population');
    ...
    Scenario(:,1) = times;     % Time of meal event (sample)
    Scenario(:,2) = carbs;     % Amount carbs in meal event (gram)
    ...
    outputArg1 = BG_Output;
    outputArg2 = Ins_input;
end
